...
public class C1_IntList_StreamOrnekleri {
    public static void main(String[] args) {
        ...
        System.out.println("karelerinTekrarsızList (list) = " + karelerinTekrarsızList(list));
        kucuktenBuyugeSirala (list);
        buyuktenKucugegeSirala (list);
        System.out.println("kuplerListe (list) = " + kuplerListe(list));
        System.out.println("karelerSon5Degil (list) = " + karelerSon5Degil(list));
        System.out.println("listElToplam (list) = " + listElToplam(list));
    ...
    private static void hepsiniYaz(List<Integer> l) {
    ...
    public static int listElToplam (List<Integer> l) {
        System.out.println();
