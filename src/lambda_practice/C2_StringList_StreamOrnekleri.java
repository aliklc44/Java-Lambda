...
public class C2_StringList_StreamOrnekleri {
    public static void main(String[] args) {
        ...
        System.out.println("dcIleBaslayanYaz(list) = " + dcIleBaslayanYaz(list));
        yidizliYaz(list);
        System.out.println("alfabetikSira (list) = " + alfabetikSira(list));
        lLeriSil(list);
        System.out.println("eOlanlarinListesi (list) = " + eOlanlarinListesi(list));
        ilkHarfi3DefaYaz (list);
        ilkHarfBuyuk (list);
        System.out.println("uzunluk4e6Haric  (list) = " + uzunluk4e6Haric(list));


    }

    // S1: ilk harfi d ve ya c olanlari listeleyelim
    public static List<String> dcIleBaslayanYaz(List<String> l) {
    ...
    public static void yidizliYaz(List<String> l) {
    ...
    public static void ilkHarfi3DefaYaz (List<String> l) {
        System.out.println();
    ...
    public static List<String> uzunluk4e6Haric  (List<String> l) {
        System.out.println();
